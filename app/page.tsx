...
const trust = [
  ...
  { num: "109",  label: "MT por 8h de acesso total", target: 109, suffix: "" },
          ...
          <div>
            <Link href="/curriculum" className="group relative rounded-3xl overflow-hidden bg-white border border-gray-100 shadow-sm p-8 flex flex-col gap-4 hover:scale-[1.02] transition-transform duration-300 hover:shadow-md hover:border-[#D20001]/20 block h-full">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm leading-relaxed">Cria, melhora e adapta o teu CV. Experimenta grátis, por 109 MT desbloqueias tudo por 8 horas.</p>
              </div>
          ...
          >
            <div>
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <span className="text-white/35 text-xs">Quer destacar-te? Acesso total por 109 MT / 8h.</span>
              </div>
            </div>
