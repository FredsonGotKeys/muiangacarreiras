...
import { Lock, Loader2, Zap, CheckCircle2, AlertCircle, Smartphone, X } from "lucide-react";
import { useAuth } from "@/lib/auth-context";
import { useEntitlement } from "@/lib/use-entitlement";
import { authFetch } from "@/lib/auth-fetch";
import AuthModal from "@/components/AuthModal";

type Fase = "inicial" | "metodo" | "aguardando" | "sucesso";
 ...
 * resolva por aqui). Reactivar mudando isto para `true`.
 */
...
export default function CompraGate({
  ...
  return (
    <div className="rounded-2xl border-2 border-dashed border-[#D20001]/30 bg-[#D20001]/5 overflow-hidden">
      {/* FASE: cartão inicial de bloqueio */}
      {fase === "inicial" && (
      ...
      {fase === "metodo" && (
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={fechar} className="w-8 h-8 rounded-xl bg-white hover:bg-gray-100 flex items-center justify-center transition-colors shrink-0">
